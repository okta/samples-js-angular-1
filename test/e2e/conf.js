...
const promises = Promise.all([
  startAndWaitFor('npm', ['start'], 'bundle is now VALID', 'green'),

  // Replace with mock okta server when we have it. This is a demonstratation
  // that we can run multiple services in parallel.
  startAndWaitFor('ls', ['-l'], 'webpack.config.js', 'magenta'),
]);
